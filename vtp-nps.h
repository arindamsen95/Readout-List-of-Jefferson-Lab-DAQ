...
#define NPS_CLUSTER_PAIR_THR_MAX NPS_ECALCLUSTER_THRESHOLD_PAIR_MASK
#define NPS_CLUSTER_PAIR_WIDTH_MAX NPS_ECALCLUSTER_PAIR_WIDTH_MASK*4
...
#define NPS_FADCMASK_ACCEPT_PRESCALE_MAX NPS_FADCMASK_ACCEPT_PRESCALE_MASK

#define NPS_FADCMASK_MODE_MAX	NPS_FADCMASK_CTRL_MODE_MASK

#define NPS_N_TRIGGER_BITS    32

int32_t vtpNPSSetEcalCluster(uint32_t seed_thr, uint32_t hit_dt, uint32_t cluster_thr, uint32_t readout_thr, uint32_t nhit_min, uint32_t cluster_pair_thr, uint32_t cluster_pair_width);
int32_t vtpNPSGetEcalCluster(uint32_t *seed_thr, uint32_t *hit_dt, uint32_t *cluster_thr, uint32_t *readout_thr, uint32_t *nhit_min, uint32_t *cluster_pair_thr, uint32_t *cluster_pair_width);
...
int32_t vtpNPSSetFadcMask(uint32_t offset, uint32_t width, uint32_t mode, uint32_t prescale);
int32_t vtpNPSGetFadcMask(uint32_t *offset, uint32_t *width, uint32_t *mode, uint32_t *prescale);
